...
<body>
    ...
    <div class="contenidoForm" style="padding: 1%;">
        ...
        <form method="POST" href="{{route('usuarios.store')}}" enctype="multipart/form-data">
            @csrf
            <h1 class="texto" >Agregar usuario</h1>
            ...
            <div class="row row-cols-1 row-cols-md-3" >
                <div class="col">
                    <label  class="form-label texto fuenteFormulario">Nombre</label>
                    <input class="form-control btnFondoColor" type="text" class="mb-3"  placeholder="" name="nombre">
                </div>

                <div class="col">
                    <label  class="form-label texto fuenteFormulario">Correo</label>
                    <input class="form-control btnFondoColor" type="text" class="mb-3"  placeholder="" name="correo">
                </div>
            ...
            <div class="mb-3">
                <label for="formFile" class="form-label texto fuenteFormulario">Foto</label>
                <input class="form-control " type="file" id="formFile" style="width: 30%;" name="foto">
              </div>
